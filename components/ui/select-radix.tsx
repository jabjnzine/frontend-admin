...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      // Base styles
      "flex h-11 w-full items-center justify-between rounded-lg border border-slate-200",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "py-2.5 pr-8 pl-8 text-sm outline-none",
      "transition-[background-color,color] duration-150 ease-out",
      // Focus state - accent color
      "focus:bg-slate-100 focus:text-slate-900",
      // Selected state - highlight with accent
      "data-[state=checked]:bg-blue-50 data-[state=checked]:text-blue-900 data-[state=checked]:font-medium",
