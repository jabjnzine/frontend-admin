...
>(({ className, sideOffset = 6, alignOffset = 0, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      collisionPadding={8}
      className={cn(
        "z-[100] overflow-hidden rounded-lg border border-slate-200 bg-white p-1 shadow-lg",
        "min-w-[8rem] w-max max-w-[16rem]",
